...
namespace SerializeReferenceEditor.Editor 
{
	...
	public class SRDrawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			//Alternatively use GetTypeName(property.managedReferenceFullTypename); to display just the end of the path.
			var typeName = GetFullTypeName(property.managedReferenceFullTypename);
			//var typeNameContent = new GUIContent(typeName + (_array != null ? (" [" + index + "]") : string.Empty)); // This will display the name with an array index.
